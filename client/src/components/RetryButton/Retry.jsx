import styled from "./retrybutton.module.css";
import useReload from "../../hooks/Reload/useReload";
//retry loading pokemon
function Retry() {
    const handleReload = useReload();

  return (
    <>
      <button onClick={()=>handleReload()} className={styled.button}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="32"
          height="32"
          className={styled.pokeball}
        >
          <path
            stroke="#000"
            fill="#fe0505"
        ...
        <span className={styled.go}>Reload</span>
        <span className={styled.pword}>Loading</span>
        <span className={styled.pword2}>Click</span>
      </button>
    </>
  );
}
